...
//based_on
//https://www.instructables.com/Cheap-Hot-Air-Station-With-Arduino/
//https://www.electronicwings.com/arduino/thermistor-interfacing-with-arduino-uno
//http://electronoobs.com/eng_arduino_tut32.php
...
void loop()
{
   ...
   delay(100);
 {
  ...
  if (Serial.read() == 'p')
  {
    ...
    {
        temperature = max_temp;  //temp limt
      }
  }
else {
  ...
  if (digitalRead (7) == LOW)
 {
    ...
    {
        temperature = min_temp;  //temp limt
      }
  }
else {
